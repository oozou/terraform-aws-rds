...
| <a name="input_event_categories"></a> [event\_categories](#input\_event\_categories) | A list of event categories for a SourceType that you want to subscribe to See http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Events.html | `list(string)` | <pre>[<br>  "failover",<br>  "failure",<br>  "low storage",<br>  "maintenance",<br>  "notification",<br>  "recovery"<br>]</pre> | no |
